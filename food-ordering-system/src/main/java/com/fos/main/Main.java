...
public class Main {
    ...
    private static void createOrder(Scanner scanner) {
        ...
        while (ordering) {
            ...
            for (int i = 0; i < foods.size(); i++) {
                ...
                System.out.printf("%d. %s (Cooking Time: %d seconds, Stock: %d)%n", i + 1, food.getName(),
                        food.getCookingTime(), food.isInStock() ? 1 : 0);
            }
            ...
            for (int i = 0; i < drinks.size(); i++) {
                ...
                System.out.printf("%d. %s (Stock: %d)%n", i + 1, drink.getName(), drink.isInStock() ? 1 : 0);
            }
    ...
    private static void viewKitchenProcesses(Scanner scanner) {
        ...
        while (true) {
            System.out.println("Press 'Esc' to exit view...");
    ...
    private static void displayKitchenProcesses() {
        ...
        System.out.printf("%-20s %-15s %-15s %-20s %-20s%n", "Order Time", "Waiting Time", "Expected Finish", "Details",
                "Pending Items");
        System.out.println(
                "------------------------------------------------------------------------------------------------");
        ...
        // Show chef and bartender activity
        ...
        for (Chef chef : kitchen.getChefs()) {
            ...
            if (currentFood != null) {
                ...
                System.out.printf("%-15s %s %-15s%n", chef.getName(), "Cooking " + currentFood.getName(),
        ...
        System.out.printf("%n%-15s %-25s%n", "Bartender", "Current Task");
        System.out.println("-------------------------------------------");
